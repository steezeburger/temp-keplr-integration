...
export const SmoothWeightChangeParams = {
  ...
  toJSON(message: SmoothWeightChangeParams): unknown {
    ...
    if (message.initialPoolWeights?.length) {
      obj.initialPoolWeights = message.initialPoolWeights.map((e) => PoolAsset.toJSON(e));
    }
    if (message.targetPoolWeights?.length) {
      obj.targetPoolWeights = message.targetPoolWeights.map((e) => PoolAsset.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<SmoothWeightChangeParams>, I>>(base?: I): SmoothWeightChangeParams {
    return SmoothWeightChangeParams.fromPartial(base ?? ({} as any));
  },
...
export const PoolAsset = {
  ...
  create<I extends Exact<DeepPartial<PoolAsset>, I>>(base?: I): PoolAsset {
    return PoolAsset.fromPartial(base ?? ({} as any));
  },
